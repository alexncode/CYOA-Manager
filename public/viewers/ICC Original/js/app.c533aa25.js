        ...
        var Mt = function() {
            ...
            Vt = {
                ...
                methods: {
                    ...
                    // Goes through all child elements and child of childs and removes any background images that it find in style attribute
                    const removeBackgroundImages = (element) => {
                        if (element.style.backgroundImage) {
                            element.style.backgroundImage = 'none';
                        }
                        if (element.children) {
                            for (let i = 0; i < element.children.length; i++) {
                                removeBackgroundImages(element.children[i]);
                            }
                        }
                    }
                    removeBackgroundImages(e.$refs.printThis);
                ...
                e.$refs.printThis.style.backgroundColor = bgColor;
                        ...
                        htmlToImage.toBlob(e.$refs.printThis, {
                            ...
                            s.download = "Finalized Build.jpg";
                            s.href = window.URL.createObjectURL(t);
                            s.dataset.downloadurl = ["image/jpeg", s.download, s.href].join(":");
